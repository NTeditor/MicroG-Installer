...
su -c pm install $MODPATH/system/app/ServicesFrameworkProxy/ServicesFrameworkProxy.apk
...
su -c pm grant com.looker.droidify "android.permission.INTERNET"
su -c pm grant com.looker.droidify "android.permission.RECEIVE_BOOT_COMPLETED"
...
mv -f $MODDIR/service.sh $MODDIR/disable-service.sh
